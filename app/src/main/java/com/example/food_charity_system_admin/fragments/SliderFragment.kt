...
import com.example.food_charity_system_admin.databinding.FragmentSliderBinding
...
class SliderFragment : Fragment() {
    ...
    private fun uploadImage(uri: Uri) {
        ...
        val refStorage = FirebaseStorage.getInstance().reference.child("slider/$filName")
    ...
    private fun storeData(image: String) {
        ...
        db.collection("slide").document("item").set(data)
            .addOnSuccessListener {
                dialog.dismiss()
                Toast.makeText(requireContext(), "Slide Updated", Toast.LENGTH_SHORT).show()
